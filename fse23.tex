...
assessment tasks, improving all the tasks at the same time.
...
Our empirical evaluation shows that on a C vulnerability dataset,
{\tool} achieves F-score of 25.5\% and MCC of 26.9\% relatively higher
than the baselines in vulnerability
...
improves the vulnerability detection over the baselines from
