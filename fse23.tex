...
\title[Context-aware, Graph-based, Commit-level Automated Vulnerability Detection and Assessment]{Context-aware, Graph-based, Commit-level Automated Vulnerability Detection and Assessment}
...
directly on the commited code changes for early detection. However,
none of them could provide both commit-level vulnerability detection
and assessment at once. Moreover, those assessment approaches still
